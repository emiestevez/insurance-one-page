						...
						success: function(msg) {
							if (parseInt(msg, 0) !== 0) {
								...
								if (msg_split[0] === 'success') {
									...
									$form.find('.submit-status').html('<div class="submit-status-text"><span class="success"><i class="fa fa-check-circle"></i> ' + 'Mensaje enviado con &eacute;xito' + '</span></div>').fadeIn(300).delay(3000).fadeOut(300);
								} else {
									...
									$form.find('.submit-status').html('<div class="submit-status-text"><span class="error"><i class="fa fa-exclamation-circle"></i> ' + 'No se pudo enviar el mensaje' + '</span></div>').fadeIn(300).delay(3000).fadeOut(300);
								}
							}
						}
					});
